          ...
          <div className={styles.aboutTextWrapper2}>
            <div className={styles.aboutTextWrapper2}>
              <p className={styles.aboutPara}>
                ...
                <span className={styles.importantWords}>coaching</span> has been
                instrumental in pushing me to new levels of{" "}
          ...
          <div className={styles.aboutTextWrapper3}>
            <div className={styles.aboutTextWrapper3}>
              ...
              <p className={styles.aboutPara}>
                ...
                was a turning point. Winning that  <span className={styles.importantWords}>competition</span> was a huge
                achievement and fueled my passion for  <span className={styles.importantWords}>powerlifting</span> even more,
                setting the tone for future  <span className={styles.importantWords}>challenges</span>.
              </p>
            </div>
          </div>
          ...
          <div className={styles.aboutTextWrapper4}>
            <div className={styles.aboutTextWrapper4}>
              <p className={styles.aboutPara}>
                ...
                Now, at{" "}
                <span className={styles.importantWords}>16 years old</span>, my
                bodyweight has increased to{" "}
                <span className={styles.importantWords}>100 kgs</span>,
                reflecting both muscle growth and the progress I've made in{" "}
                <span className={styles.importantWords}>powerlifting</span>. The
                journey has been intense and rewarding, shaping not only my
                physique but also my{" "}
