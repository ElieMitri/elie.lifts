          ...
          <div className={styles.aboutWrapper}>
            <div className={styles.aboutTextWrapper}>
              <p className={styles.aboutPara}>
                ...
                and proud national champion in the under-93kg sub-junior
                category in Lebanon.
              </p>
            ...
            <div className={styles.aboutTextWrapper}>
              ...
              <p className={styles.aboutPara}>
                ...
                began with a commitment to pushing past personal limits and
                growing stronger every day. With the guidance of an incredible{" "}
                <span className={styles.importantWords}>coach</span>, I’ve
                dedicated countless hours to refining my technique and building
                the strength needed to compete and succeed. Winning nationals
                was a milestone, but it's only the{" "}
                <span className={styles.importantWords}>beginning</span>. I’m
                excited to keep challenging myself and pursuing new records on
                this path in competitive powerlifting.
              </p>
            </div>
          </div>
        </div>
